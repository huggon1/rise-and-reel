...
一款轻松的桌面端钓鱼游戏：既可独自游玩，也可进行 2–4 人本地对战。
...
v0.1.0 专为桌面端键盘操作设计。多人比赛使用各自独立的钓鱼赛道，且不会写入单人历史。协作式 2D 钓鱼、移动端触控、云同步、账号、会话恢复和背景音乐仍不在此版本范围内。
...
打开 `http://localhost:5173`，选择 **单人钓鱼** 或 **多人模式**。多人模式支持 2–4 人共用一个键盘，每人绑定一个不同按键。
